...
<div class="container">
 ...
 <header>
  <nav>
    <div class="logo">
      <a href="#"><img src="img/kievyan.PNG" class="img_1"></a>
    </div>
    <ul>
      <li><a href="#Գխավոր">Գխավոր</a></li>
      <li><a href="#Տեսականի">Տեսականի</a></li>
      <li><a href="#ԱՊՐԱՆՔՆԵՐ">ԱՊՐԱՆՔՆԵՐ</a></li>
      <li><a href="#Կոնտակտ">Կոնտակտ</a></li>
    </ul>
  </nav>
</header>
...
<section class="showcase">
  <img src="img/raiber.jpg" alt="Picture">
  <div class="overlay">
    <h2>Կիևյան Շինանյութ</h2>
    <p>
    Կիևյան Շինանյութ
	    Ամեն Ինչ Շինարարության Իրականացման Համար, Սոսինձներ / Հավելանյութեր / Շինարարական Քիմիա, Երեսպատում և Հարդարում, Մեկուսիչ Նյութեր
  ...
  <div class="typewriter">Կիևյան Շինանյութ</div>
		  <!--efect text end-->
</div>
	 <!--text section-->
	 <div class="section">
  ...
  <div class="wrapper">
    <div class="box">
      <p>Սալիկի Սոսինձ
Սալիկի Կարանների Լցանյութ
Քարի / Էպօքսիդային Սոսինձ
Սոսինձ Պոլիվինիլացետատային</p>
      </div>
      <div class="box">
      <p>Պաստառների Սոսինձ
Սոսինձ Մանրահատակի
Ակրիլային Հերմետիկներ
Սիլիկոնային Հերմետիկներ
Հակասնկային Հերմետիկներ
Սոսինձների և Հերմետիկների Հիմքեր (Պրայմերներ)
Էլեկտրական Գործիքներ</p>
      </div>
        <div class="box">
      <p>Ձեռքի Գործիքներ
Էլեկտրական Գործիքների Պարագաներ
Նախաներկեր
Հերմետիկներ</p>
	  ...
	  <div class="box">
			<p>Ներմուծում՝</p>
			<p>Էլեկտրական Գործիքներ
Ձեռքի Գործիքներ
Էլեկտրական Գործիքների Պարագաներ</p>
	 ...
	 <!--galery-->
	  <p class="heading">
  <div class="gallery-image" id="Տեսականի">
    <div class="img-box">
      <img src="img/lvacaran.jpg" alt="" />
    ...
    <div class="img-box">
	 ...
	 <!--Գները և Ապրանքներ-->
	 <wrapper>
  <div class="container-section" id="ԱՊՐԱՆՔՆԵՐ">
    ...
    <ul role="list" class="cards" id="cards" data-layout="grid">
      ...
      <li>
        <div class="card">
          ...
          <div class="card__content">
            <h3>Սալիկի Կարանների Լցանյութ</h3>
           <p>300դր</p>
            <a href="#" class="button">Start</a>
          </div>
        </div>
   ...
   <img src="img/nerker_1.jpg" alt="" />
      ...
      <li>
        <div class="card">
          ...
          <div class="card__content">
            <h3>Սոսինձ Պոլիվինիլացետատային</h3>
            <p>300դր</p>
            <a href="#" class="button">Start</a>
          </div>
        </div>
	 ...
	 <footer class="footer" id="Կոնտակտ">
  ...
  <div class="footer-center col-md-4 col-sm-6">
    <div>
      ...
      <p><span>Երևան, 0028, Կիևյան փող. 8</span></p>
    </div>
    <div>
      <i class="fa fa-phone"></i>
      <p> Հեռախոս (374) - 044 051111</p>
    </div>
    <div>
      <i class="fa fa-envelope"></i>
      <p><a href="#"> Valirov-ltd@mail.ru</a></p>
    </div>
	  <div class="text-footer">
		  <p>#գործ կա
Կիևյան Շինանյութ խանութին անհրաժեշտ է ՀԾ մասնագետ.
Պարտականությունները`
Ծրագրի լիարժեք իմացություն, պատասխանատվություն,Word, Excel ծրագրերի պարտադիր իմացություն
Աշխատանքի ժամերը full time.
Այս ոլորտում աշխատանքային փորձը ցանկալի է։
Հարցերի համար
☎️044071111</p></div> <
  </div>
  <div class="footer-right col-md-4 col-sm-6">
    ...
    <p class="menu">
      ...
      <a href="#"> Portfolio</a> |
      <a href="#"> News</a> |
      <a href="#Կոնտակտ" target="_self">Կոնտակտ</a>
    </p>
...
<a href="#" class="cd-top text-replace js-cd-top">Top</a>
	  <div class="text-footer">
		   <p>#գործ կա
Կիևյան Շինանյութ խանութին անհրաժեշտ  ԽՈՐՀՐԴԱՏՈՒ-ՎԱՃԱՌՈՂ շխատանքային փորձը ցանկալի է։
		  Հարցերի համար
☎️044071111</p>
	  </div>
  </div>
